...
- Press the left and right mouse buttons together on a belt carrying a shape to read the nearest shape item on that belt path.
...
3. Press the left and right mouse buttons together on a belt line that is currently carrying a shape item.
